...
**Public availability statement**: Source data are available upon request (read more [here](https://inport.nmfs.noaa.gov/inport/item/22560)). Derived data may be downloaded [here](https://comet.nefsc.noaa.gov/erddap/tabledap/SOE_habitat_2018.html).
...
soe.plot(SOE.data.2018, "Time", "black sea bass spring mean depth", 
         stacked = "A", rel.y.num = 1.1, suppressAxis = T, 
          tol = 0.15, x.start = 1963, end.start = 2007,
         cex.stacked = 1.5)
soe.plot(SOE.data.2018, "Time", "black sea bass fall mean depth", 
