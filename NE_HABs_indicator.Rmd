...
```{r NE_HAB_image, echo = F, fig.align="center",fig.cap="Regional HAB-related shellfish bed closures in New England (2007-2016)."}
image.dir <- './images'
