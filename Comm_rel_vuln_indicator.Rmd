...
#### Plot output
```{r commvulmap , fig.cap="Commercial (A) and recreational (B) reliance and social vulnerability in the Mid-Atlantic Bight. \\label{commvulmap}", cache=TRUE, echo = T, message=F, include=T, warning=F, fig.show='hold', fig.width = 8,fig.height = 5.4,fig.pos='H',fig.align='center'}
#Libraries
library(rgdal)
