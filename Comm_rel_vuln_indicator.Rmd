...
#### Plot output
```{r map1, echo = T, eval=T, fig.cap="Commercial (A) and recreational (B) reliance and social vulnerability in the Mid-Atlantic Bight \\label{commvulmap}", fig.show='hold', fig.width = 8,fig.height = 5.4,fig.pos='H',fig.align='center'}
