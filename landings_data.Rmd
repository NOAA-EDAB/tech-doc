...
**Indicator category**: 1. Database pull
...
**Public availability statement**: Need to check on this one...possible confidentiality issue.  Derived data can be made 
available.
...
series with three distinct time frames as noted in the table (\@ref(tab:calibration_factors) below.  

```{r calibration_factors, eval = T, echo = F}
