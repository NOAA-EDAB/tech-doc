...
In a preliminary simulation study, we explored the effect of time series length and autocorrelation strength on statistical power of three trend detection methods. Overall, when sample size was low (N = 10) there was a high rate of false trend detection, and similarly, a low rate of true trend detection. Both of these forms of error were further amplified by autocorrelation in the observed time series. Based on these findings, we selected a minimum series length of N = 30 for indicator time series before assessing trend. We also chose to use a GLS model selection (GLS-MS) approach to assess for trend in State of the Ecosystem reports, as this approach performed best overall. GLS-MS also allows for both linear and quadratic model fits and quantification of uncertainty in the trend estimate. 
