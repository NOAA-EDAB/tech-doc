...
**Data steward**: Harvey Walsh, NEFSC OCB, <harvey.walsh@noaa.gov>, Mike Jones, NEFSC DMS, <michael.jones@noaa.gov>
  
**Point of contact**: Ryan Morse, NEFSC EDAB, <ryan.morse@noaa.gov>, Harvey Walsh, NEFSC OCB, <harvey.walsh@noaa.gov>
  
**Public availability statement**: Data are publicly available here:
...
### Data extraction 
Data are from the publicly available zooplankton dataset on the NOAA ftp site. The excel file has a list of excluded samples and cruises based on @Kane2007 and @Kane2011.
