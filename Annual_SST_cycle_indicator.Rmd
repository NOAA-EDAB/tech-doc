...
### Plotting
```{r plotting, echo = T, eval = T, fig.cap = "Long-term mean (1982-2012) SSTs for the Mid-Atlantic Bight (A), Georges Bank (B), and Gulf of Maine (C) are shown by the black line, with +/- 1 SD shaded in grey. Red or dark blue shaded regions show where mean daily SSTs exceeded +/- 1 SD in 2017, and orange and cyan shaded regions show where mean daily SSTs were above or below the long-term mean.", fig.width=8, fig.height=3.25, fig.align='center'}
