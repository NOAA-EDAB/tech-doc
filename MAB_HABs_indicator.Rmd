...
**Public availability statement**: Source data for this indicator are available [here](https://github.com/NOAA-EDAB/tech-memo/tree/master/data/CB_HAB). Processed time series can be found [here](http://comet.nefsc.noaa.gov/erddap/tabledap/CBhabs_ann_soe_v2.html).
...
```{r packages, eval = T, echo=T, message=FALSE, warning=FALSE, include=T}
#SOE R packages
