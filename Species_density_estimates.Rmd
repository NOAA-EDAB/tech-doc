...
## Methods
We used kernel density plots to depict shifts in species' distributions over time. These figures characterize the probability of a species occurring in a given area based on NEFSC fall Bottom Trawl Survey data. Kernel density estimates (KDEs) of distributions (shaded regions) are shown for the period of 1970-1979 (shaded blue) and most recent three years of survey data (shaded red). Results are typically visualized for spring and fall bottom trawl surveys seperately. 
