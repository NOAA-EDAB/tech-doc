...
The species selected in each year were determined by their cumulative contribution to total landings. Prior to 2026, a threshold of at least 80% of the total landings was used (due to the fact that trophic level estimates were not availabale for many species). From 2026, trophic level esimates are avilabale for all species and therefore, 100% of the landings are used in the PPR calculation.

### Data sources

Data for this index come from a variety of sources. The landings data come from the Catch Accounting and Monitoring System (CAMS), via the Stock Efficiency initiative (STOCKEFF). Species trophic level information come from [fishbase](http://fishbase.de) and [sealifebase](http://sealifebase.ca), and primary production estimates are derived from [satellites](#chl_pp). Some of these data are typically not available to the public.

### Data extraction

Landings are extracted from the Catch Accounting and Monitoring System (CAMS), via the Stock Efficiency initiative (STOCKEFF) using the methods described in the chapter [Commercial Landings Data.](#comdat)
