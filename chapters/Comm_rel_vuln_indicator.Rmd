...
### Plotting
Code forplotting the community reliance vulnerability indicator can be found [here](https://github.com/NOAA-EDAB/tech-doc/tree/master/R/stored_scripts/comm_rel_vuln_plotting.R). 
