...
```{r , fig.cap = "Environmental justice indicators (Poverty index, population composition index, and personal disruption index) for top commercial fishing communities in the Mid-Atlantic.", fig.width=50}


knitr::include_graphics(c(file.path(image.dir, "EJ_Commercial_MAB.png")))
...
```{r , fig.cap = "Environmental justice indicators (Poverty index, population composition index, and personal disruption index) for top recreational fishing communities in the Mid-Atlantic.", fig.width=50}


knitr::include_graphics(c(file.path(image.dir, "EJ_Recreational_MAB.png")))
