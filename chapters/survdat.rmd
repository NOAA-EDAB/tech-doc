...
SOE products; [Aggregate biomass](#aggregate_biomass), [Survey diversity metrics](#shannon_survey), [Expected number of species](#exp_n), [Species Condition](#condition), [Massachusetts inshore survey](#mab_inshore_survey)
...
Prior to 2020, `survdat` would post stratified into EPUs by labeling stations with the EPU that contained them. 
