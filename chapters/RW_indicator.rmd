...
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna.Rmd_MAB-narw-abundance.R"), fig.cap="North Atlantic right whale population estimates shown with 95% credible intervals.",echo = F, message=F, warning=F,  fig.pos='H', fig.height = 4.5, fig.width=7}
