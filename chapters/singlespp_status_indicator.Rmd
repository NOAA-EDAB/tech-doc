...
The following R code was used to process the stock status data set for inclusion in the `ecodata` R package.
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/data-raw/get_stocks.R"), eval = F, echo = T}
...
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/SOE-NEFMC/master/chunk_scripts/NE-NE-stock-status.R"), warning=F, fig.cap = "Summary of single species status for NEFMC and jointly managed stocks.", fig.width = 8, fig.asp = 0.65, eval=T, echo=T}
