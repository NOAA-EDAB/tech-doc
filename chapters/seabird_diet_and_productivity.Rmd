...
```{r bird-prod, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/SOE-NEFMC/master/chunk_scripts/NE-tern-prod-div.R"),fig.width = 8, fig.asp = 0.25, echo = T, fig.align="center", eval = T, fig.cap= '(ref:bird-prod)'}
...
```{r nest-sites, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/SOE-NEFMC/master/chunk_scripts/NE-map-and-prey.R"), fig.height = 4, fig.align="center", eval=T, echo=T, fig.cap='(ref:nest-sites)'}
