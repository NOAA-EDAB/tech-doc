...
```{r th-maps,fig.cap="Current thermal habitat estimate (A), and 20-40 year thermal habitat projection (B) for summer flounder on the Northeast Continental Shelf." ,  out.width="90%", warning=F, message=F}

knitr::include_graphics(file.path(image.dir, "thermal_habitat.png"))
