...
**Public availability statement**: Source data is available to the public (see [Data Sources](#sg-data-sources)). 
...
*    [Spring Botton Trawl Survey](https://inport.nmfs.noaa.gov/inport/item/22561)
*    [Fall Bottom Trawl Survey](https://inport.nmfs.noaa.gov/inport/item/22560)
*    [Commercial Fisheries Database](https://inport.nmfs.noaa.gov/inport/item/27401)- This has been superseded by the Catch Accounting and Monitoring System (CAMS)
*    [NE-IEA program](http://integratedecosystemassessment.noaa.gov)
*    [New Engalnd Fisheries Management Council](https://www.nefmc.org/)
*    [Mid-Atlantic Fisheries Management Council](http://www.mafmc.org/)
