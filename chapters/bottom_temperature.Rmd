...
Code for plotting Georges Bank and Gulf of Maine bottom temperature time series can be found [here](https://github.com/NOAA-EDAB/SOE-NEFMC/blob/master/chunk_scripts/LTL.Rmd-NE-bot-temp.R). 
