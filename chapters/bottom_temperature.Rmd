...
Derived bottom temperature data were formatted for inclusion in the `ecodata` R package using the R code found [here](https://github.com/NOAA-EDAB/ecodata/blob/master/data-raw/get_oceantemp_insitu.R). 

### Plotting

Code for plotting Georges Bank and Gulf of Maine bottom temperature time series can be found [here](https://raw.githubusercontent.com/NOAA-EDAB/SOE-NEFMC/master/chunk_scripts/LTL.Rmd-NE-bot-temp.R)

```{r oyster-aqua, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL.Rmd-NE-bot-temp.R"), eval=TRUE, echo = FALSE, fig.cap = "Georges Bank and Gulf of Maine annual bottom temperature anomalies."}
