...
#### Mid-Atlantic
Code for plotting Mid-Atlantic bottom temperature map and time series can be found [here](https://github.com/NOAA-EDAB/ecodata/blob/master/chunk-scripts/LTL_MAB.Rmd-seasonal-bt-anom-gridded.R).

```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-seasonal-bt-anom-gridded.R"), eval=TRUE, echo = FALSE, fig.cap = "Seasonal bottom temperature in the Mid-Atlantic."}

```

#### New England

Code for plotting Georges Bank and Gulf of Maine bottom temperature map can be found [here](https://github.com/NOAA-EDAB/ecodata/blob/master/chunk-scripts/LTL.Rmd-NE-seasonal-bt-anom-gridded.R).

```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_NE.Rmd-seasonal-bt-anom-gridded.R"), eval=TRUE, echo = FALSE, fig.cap = "Seasonal bottom temperature map in the New England."}
