...
The Cold Pool Index (Model_CPI) was adapted from @miller2016 based on the method developed in @dupontavice2022. Residual temperature was calculated in each grid cell, i, in the Cold Pool domain as the difference between the average bottom temperature at the year y (Ty) and the average bottom temperature over the period 1958–2021 $$({\bar{T}}_{i,\ 1958-2021})$$ between June and September. Model_CPI was calculated as the mean residual temperature over the Cold Pool domain such that:
