...
### Data Sources
Three bottom temperature products are used to get bottom temperature from 1958 to 2021 (table below). 

| Data            | Description          |Period | Initial Resolution | REGRID | Reference              |
|-----------------|----------------------|-------|--------------------|--------|------------------------|
| ROMS | Numerical simulation of the NWA Ocean was performed with the Regional Ocean Modelling System (ROMS-NWA) | 1958-1992 | ~7km | 1/10° | @Shchepetkin2005 |
| GLORYS | Global Ocean Physics Reanalysis ([Glorys reanalysis](https://resources.marine.copernicus.eu/product-detail/GLOBAL_REANALYSIS_PHY_001_030/INFORMATION)) | 1993-2019 | 1/12° | 1/10° | @Fernandez2018 |
| Global forecast | [Global Ocean Physics Analysis and Forecast updated Daily](https://resources.marine.copernicus.eu/product-detail/GLOBAL_ANALYSIS_FORECAST_PHY_001_024/INFORMATION)| 2020-2021 |  1/12° | 1/10° | @Lellouche2018 |

Furthermore, we use bottom temperature from the [Northwest Atlantic Regional Climatology](https://www.ncei.noaa.gov/products/northwest-atlantic-regional-climatology) to estimate a monthly decadal bias (@Seidov2016a, @Seidov2016b).
...
The Cold Pool Index (Model_CPI) was adapted from Miller et al. (2016). Residual temperature was calculated in each grid cell, i, in the Cold Pool domain as the difference between the average bottom temperature at the year y (Ty) and the average bottom temperature over the period 1958–2021 $$({\bar{T}}_{i,\ 1958-2021})$$ between June and September. Model_CPI was calculated as the mean residual temperature over the Cold Pool domain such that:



$${{CPI}_y}=\ \frac{\sum_{i=1}^{n}{{(T}_{i,\ y}\ -\ {\bar{T}}_{i,\ 1958-2021})\ }}{n}$$
...
$${PI}_y=\ \frac{\sum_{i=1}^{n}{{(Month}_{i,\ y}\ -\ {\bar{Month}}_{i,\ 1958-2021})\ }}{n}$$
