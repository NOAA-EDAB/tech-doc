...
See the [workedExample vignette](https://NOAA-EDAB.github.io/eofindices/articles/workedExample.html) in the [eofindices](https://github.com/NOAA-EDAB/eofindices/) package for plotting code.

Figures for Mid-Atlantic Bight are presented in this document. For Georges Bank and the Gulf of Maine, please visit [here]((https://github.com/NOAA-EDAB/eofindices/tree/master/vignettes/figures))
