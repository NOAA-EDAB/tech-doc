...
Trophic level information for each species is obtained from [fishbase](http://fishbase.de) and [sealifebase](http://sealifebase.ca) using the R package [rfishbase](https://github.com/ropensci/rfishbase) [@froese2019fishbase] in tandem with the package [ecosystemeof.](https://github.com/NOAA-EDAB/ecosystemeof/)
...
All created using the [ecosystemeof](https://github.com/NOAA-EDAB/ecosystemeof)

See the [workedExample vignette](https://NOAA-EDAB.github.io/ecosystemeof/articles/workedExample.html) in the [ecosystemeof](https://github.com/NOAA-EDAB/ecosystemeof/) package for plotting code.

Figures for Mid-Atlantic Bight are presented in this document. For Georges Bank and the Gulf of Maine, please visit [here]((https://github.com/NOAA-EDAB/ecosystemeof/tree/master/vignettes/figures))
