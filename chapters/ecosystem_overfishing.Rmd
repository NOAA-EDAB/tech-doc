...
**Description**: Time Series of Fogarty and Ryther Indices.
...
See the [workedExample vignette](https://andybeet.github.io/indexPPR/articles/workedExample.html) in the [indexPPR](https://github.com/andybeet/indexPPR/) package for plotting code.

Figures for Mid-Atlantic Bight are presented in this document. For Georges Bank and the Gulf of Maine, please visit [here]((https://github.com/andybeet/indexPPR/tree/master/vignettes/figures))
