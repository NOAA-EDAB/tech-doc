...
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_MAB.Rmd-recdat-landingsR"), fig.cap = "Total recreational seafood harvest in the Mid-Atlantic.", eval=T, echo=F}
