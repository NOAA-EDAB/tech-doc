...
### Plotting
 Code used to plot harbor porpoise data can be found [here](https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-harborporpoise.R).

```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-harborporpoise.R"), eval = T, echo=F, fig.cap="Estimated Harbor porpoise bycatch (black) and the potential biological removal (red)."}
