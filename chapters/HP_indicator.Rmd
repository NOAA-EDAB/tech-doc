...
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-grayseal.R"), eval = T, echo=F, fig.cap="Estimated Gray Seal (black - 5yr, Blue - 1yr New England) and the potential biological removal (red)."}
