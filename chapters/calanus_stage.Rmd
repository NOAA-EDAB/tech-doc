...
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_NE.Rmd-calanus-stage.R"), eval=TRUE, echo = FALSE, fig.cap = "New England Calanus stage."}
