...
## Methods
### Data sources
Level 1A ocean color remote sensing data from the Sea-viewing Wide Field-of-view Sensor (SeaWiFS) [@NASA1] on the OrbView-2 satellite, the Moderate Resolution Imaging Spectroradiometer (MODIS) [@NASA2] on the Aqua satellite and the Visible and Infrared Imager/Radiometer Suite (VIIRS) [@NASA3] on the Suomi National Polar-orbiting Partnership (S-NPP) platform were acquired from the NASA Ocean Biology Processing Group (OBPG).  Daily Level 3 mapped (4km resolution, sinusoidally projected) satellite chlorophyll data were obtained from the European Space Agency’s Ocean Colour Climate Change Initiative project. Sea Surface Temperature (SST) data included the 4 km nighttime NOAA Advanced Very High Resolution Radiometer (AVHRR) Pathfinder [@Casey2010; @Saha2018] and the Group for High Resolution Sea Surface Temperature (GHRSST) Multiscale Ultrahigh Resolution (MUR, version 4.1) Level 4 [@SOE4; @SOE14] data.  Prior to June 2002, AVHRR Pathfinder data are used as the SST source and MUR SST in subsequent years.

NASA Goddard Space Flight Center, Ocean Ecology Laboratory, Ocean Biology Processing Group. Sea-viewing Wide Field-of-view Sensor (SeaWiFS) Level 1 Data; NASA OB.DAAC, Greenbelt, MD, USA. doi: 10.5067/ORBVIEW-2/SEAWIFS/L1/DATA/1.
NASA Goddard Space Flight Center, Ocean Ecology Laboratory, Ocean Biology Processing Group. Moderate-resolution Imaging Spectroradiometer (MODIS) Aqua {Dataset Name} Data; NASA OB.DAAC, Greenbelt, MD, USA. doi: 10.5067/AQUA/MODIS/L2/OC/2018.
NASA Goddard Space Flight Center, Ocean Ecology Laboratory, Ocean Biology Processing Group. Visible and Infrared Imager/Radiometer Suite (VIIRS) Level 1A Data; NASA OB.DAAC, Greenbelt, MD, USA. doi: 10.5067/NPP/VIIRS/L2/OC/2018.
