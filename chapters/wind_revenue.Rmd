...
Modeled vessel trip report (VTR) data using the fishing footprint method (@depiper_statistically_2014 and @benjamin_visualizing_2018) linked with dealer reports for annual landings and revenue within wind lease areas and dealer report data for annual GARFO landings/revenue.
...
The underlying raster data is defined in @benjamin_visualizing_2018. Visualizing fishing data as rasters. NEFSC Ref Doc 18-12; 24 p.
