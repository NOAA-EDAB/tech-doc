...
<!-- knitr::include_graphics(paste0(imagePath,"/PPR-GB-0.80.png")) -->
<!-- knitr::include_graphics(paste0(imagePath,"/MTL-GB-0.80.png")) -->
<!-- knitr::include_graphics(paste0(imagePath,"/PP-GB.png")) -->
<!-- knitr::include_graphics(paste0(imagePath,"/composition-GB-0.80.png")) -->
<!-- ``` -->
...
<!-- knitr::include_graphics(paste0(imagePath,"/PPR-GOM-0.80.png")) -->
<!-- knitr::include_graphics(paste0(imagePath,"/MTL-GOM-0.80.png")) -->
<!-- knitr::include_graphics(paste0(imagePath,"/PP-GOM.png")) -->
<!-- knitr::include_graphics(paste0(imagePath,"/composition-GOM-0.80.png")) -->
<!-- ``` -->

#### Mid-Atlantic Bight (MAB)

<!-- ```{r, pprmab,  echo=FALSE, out.width='50%'} -->
<!-- knitr::include_graphics(paste0(imagePath,"/PPR-MAB-0.80.png")) -->
<!-- knitr::include_graphics(paste0(imagePath,"/MTL-MAB-0.80.png")) -->
<!-- knitr::include_graphics(paste0(imagePath,"/PP-MAB.png")) -->
<!-- knitr::include_graphics(paste0(imagePath,"/composition-MAB-0.80.png")) -->
<!-- ``` -->
...
>>>>>>> 1ce9975346a195af0d4a50f06c92672cf299f556
