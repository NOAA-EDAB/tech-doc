...
Shapefiles were converted to `sf` objects for inclusion in the ecodata R package using the following R code.

```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/data-raw/get_epu_sf.R"), eval = F, echo = T}
