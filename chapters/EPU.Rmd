...
**Public availability statement**: Ecological production unit (EPU) shapefiles are available [here](https://github.com/NOAA-EDAB/tech-doc/tree/master/gis). 
...
## Adaptations for the State of the ecosystem report

The definition of an EPU, for all indices used in the State of the ecosystem report is as follows:

* For commercial data - EPUs are defined by Greater Atlantic Region Statistical Areas. See [Commercial landings data](#comdat)
* For survey data - EPUs are defined by [survey data](#survdat)
...
```{r EPUmap, fig.cap="Map of the four Ecological Production Units, including the Mid-Atlantic Bight (light blue), Georges Bank (red), Western-Central Gulf of Maine (or Gulf of Maine; green), and Scotian Shelf-Eastern Gulf of Maine (dark blue)", fig.align='center', out.width = '50%', echo = F}
...
Shapefiles were converted to `sf` objects for inclusion in the `ecodata` R package 
