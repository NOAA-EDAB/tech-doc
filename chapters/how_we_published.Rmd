...
Migrated to Travis.com from Travis.org using instructions at https://docs.travis-ci.com/user/migrate/open-source-repository-migration/#can-i-migrate-multiple-repositories-at-once

This trivial change to a non-tech-doc bookdown file may trigger a new build. Let's hope it is successful!
