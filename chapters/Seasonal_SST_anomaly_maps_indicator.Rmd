...
```{r MAB-SST, echo = F, fig.align="center", fig.cap="MAB seasonal sea surface temperature time series overlaid onto 2019 seasonal spatial anomalies."}

knitr::include_graphics(file.path(image.dir, "seasonal_SST_plot.png"))
```
