...
```{r sst-anom, echo = F, eval = T, fig.cap = "Seasonal sea-surface temperature anomalies in the Mid-Atlantic Bight.", out.width='80%'}

knitr::include_graphics(file.path(image.dir, 'sst-anom.png'))
```
