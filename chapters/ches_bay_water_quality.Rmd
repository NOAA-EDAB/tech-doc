...
The indicator data set was formatted for inclusion in the ecodata R package using the following R script. 
```{r, code = readLines(here::here("source/get_ches_bay_wq.R")), eval = F, echo = T}
