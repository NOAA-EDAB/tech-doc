...
```{r kde-fig, fig.cap="Current and historical sea scallop kernel density estimates derived from spring survey data. Current estimates derived from 2016-2018 data.", echo = F, eval = T, out.width="90%"}
