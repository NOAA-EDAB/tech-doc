...
Since 2019, survey strata where characterized as being within an [Ecological Production Unit](#epu)
based on where at least 50% of the area of the strata was located.  While this does not
...
Prior to 2019, Survdat was first post stratified into EPUs by labeling stations by the EPU they fell within
...
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna.Rmd-agg-bio.R"), fig.cap="Spring (left) and fall (right) surveyed biomass in the Mid-Atlantic Bight. Data from the NEFSC Bottom Trawl Survey are shown in black, with NEAMAP shown in red.",  echo = F, fig.align='default',warning = F}
