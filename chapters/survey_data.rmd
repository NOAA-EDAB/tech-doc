...
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna.Rmd-agg-bio.R"), fig.cap="Spring (left) and fall (right) surveyed biomass in the Mid-Atlantic Bight. Data from the NEFSC Bottom Trawl Survey are shown in black, with NEAMAP shown in red.",  echo = F, fig.align='default',warning = F, fig.height=6, out.width= "50%", fig.show = 'hold'}
