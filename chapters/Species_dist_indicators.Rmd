...
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna.Rmd-spec-dist.R"), fig.cap = "Aggregate species distribution depth along shelf distance (northward shift) and depth.", eval=T, echo=F}
