...
Species distribution indicators were derived using the R code found [here](https://github.com/NOAA-EDAB/tech-doc/blob/master/R/stored_scripts/species_distribution_analsyis.R). 
...
### Plotting
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna.Rmd-spec-dist.R"), fig.cap = "Aggregate species distribution depth along shelf distance (northward shift) and depth.", fig.align="center", eval=T, echo=F}
