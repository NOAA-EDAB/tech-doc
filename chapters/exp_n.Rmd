...
### Data sources
Data used for the calculation of the expected number of species come from the Northeast Fisheries Science Center's survey database (SVDBS) as descrived in the [Survey Data](#survdat) section. These data are available to qualified researchers upon request. More information on the data request process is available under the "Access Information" field [here](https://inport.nmfs.noaa.gov/inport/item/22560).
