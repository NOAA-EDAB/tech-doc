...
**Public availability statement**: Derived CAMS data are available for this analysis (see [Commercial landings data](#comdat)).
  
## Methods

### Data sources

Data used in the Bennet Indicator were derived from the [Commercial Landings data](#comdat); a processed subset of the Catch Accounting and Monitoring System (CAMS) formaly the Commercial Fisheries Database System (CFDBS).

### Data extraction 

For information regarding processing of CAMS, please see [Commercial Landings data](#comdat) methods. The dataset containing seafood landings data was subsetted to US landings after 1981 where revenue was $\ge$ 0 for each Ecological Production Unit (i.e. Mid-Atlantic Bight, Georges Bank, and Gulf of Maine). Prior to 1981, the estimated value of the catch can not be verified.
