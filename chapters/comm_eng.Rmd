...
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_MAB.Rmd-engagement.R"), eval = T, fig.cap= "Community engagement in the Mid-Atlantic."}
