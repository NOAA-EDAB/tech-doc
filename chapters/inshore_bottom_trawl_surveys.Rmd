...
**New England**
```{r, code = readLines(here::here("source/get_inshore_survdat.R")), eval = F, echo = T}

```

**Massachusetts**
```{r, code = readLines(here::here("source/get_mass_inshore_survey.R")), eval = F, echo = T}

```

**Mid-Atlantic (NEAMAP)**
```{r, code = readLines(here::here("source/get_mab_inshore_survey.R")), eval = F, echo = T}
