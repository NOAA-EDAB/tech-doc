...
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_NE.Rmd-comdat-total-landings.R"), eval=TRUE, echo=FALSE, fig.cap="Total commercial seafood landings (black) and New England managed seafood landings (red)."}
```
