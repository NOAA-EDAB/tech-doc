...
### Plotting
Code used to plot ichthyoplankton diversity can be found [here](https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-ichthyo-diversity.R). 

```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/macrofauna_MAB.Rmd-ichthyo-diversity.R"), eval = T, echo=F, fig.cap="Ichthyolpankton Diversity in the Mid-Atlantic Bight."}
