...
**Data steward**: Maxwell Grezlik <maxwell.grezlik@noaa.gov>
  
**Point of contact**: EDAB <edab.data@noaa.gov>
  
**Public availability statement**: Source data are publicly available. Initial model development (used in the SOE published in 2023-2025) is available at: https://github.com/NOAA-EDAB/benthos_index.html. Code for data updates (used in the SOE published in 2026-present) is available at: https://github.com/NEFSC/READ-EDAB-VAST_indices/tree/main/benthos.
