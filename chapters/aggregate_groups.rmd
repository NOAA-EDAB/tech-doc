...
kable(soe.18.class, booktabs = TRUE,
      caption = "Aggregate groups use in 2018 SOE.  Classifications are based on @link2006EMAX.")
```
...
#Rename columns
setnames(species, c('MANAGE', 'EBFM.PDT', 'Feeding.guild'), 
         c('Fed.Managed', 'SOE.17', 'SOE.18'))
...
size <- data.table(COMNAME = c(rep('SMOOTH DOGFISH',           2), 
                   ...
                   Min.size = c(41, 61, 10, 41, 61, 10, 31, 61, 81, 10, 31, 31,
                                ...
                                51, 81, 10, 21, 51, 10, 21, 51, 81, 10, 21, 41, 
                                10, 21, 41, 10, 21, 
                   ...
                   Garrison.Link = as.character(c(1, 1, 2, 2, 6, 3, 3, 6, 6, 3, 
                                                  3, 4, 5, 5, 6, 
...
ed_spp <- as.data.table(sprintf("https://comet.nefsc.noaa.gov/erddap/tabledap/%s.csv",
                                "species_groups_2018") %>% 
