...
[here](https://github.com/NOAA-EDAB/ecodata/blob/master/chunk-scripts/LTL.Rmd-long-term-sst.R). 

```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-long-term-sst.R"), eval = T, echo=F, fig.cap="Long-term sea surface temperatures on the Northeast Continental Shelf.", fig.align="center", fig.height=7 }
