...
**Abundance anomaly**
```{r, code = readLines(here::here("source/get_zoo_anom_sli.R")), eval = F, echo = T}

```


**Seasonal abundance**
```{r, code = readLines(here::here("source/process_oi.R")), eval = F, echo = T}

```


```{r, code = readLines(here::here("source/get_zoo_oi.R")), eval = F, echo = T}
