...
Code used for zooplankton data analysis can be found [here](https://github.com/NOAA-EDAB/tech-doc/blob/master/R/stored_scripts/zooplankton_analsyis.R). 
...
Zooplankton abundances indicators were formatted for inclusion in the `ecodata` R package using the code linked below.

[Abundance anomaly](https://github.com/NOAA-EDAB/ecodata/blob/master/data-raw/get_zoo_abun_anom.R)

[Seasonal abundance](https://github.com/NOAA-EDAB/ecodata/blob/master/data-raw/get_zoo_oi.R)

### Plotting

**Abundance anomaly**

```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL.Rmd-MAB-zoo-abund.R"), fig.cap= "Large (red) and small-bodied (blue) copepod abundance in the Mid-Atlantic Bight.",  echo = F, fig.align='default',warning = F, fig.height=6, out.width= "50%", fig.show = 'hold'}

```


```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL.Rmd-MAB-euph-cnid.R"), fig.cap="Stratified abundance of cnidarians and euphausiids in Mid-Atlantic Bight.",  echo = F, fig.align='default',warning = F, fig.height=6, out.width= "50%", fig.show = 'hold'}

```

**Zooplankton Diversity**

```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL.Rmd-MAB-zoo-abund1.R"), fig.width = 8, fig.asp = .35, fig.cap="Zooplankton diversity in the Mid-Atlantic Bight."}
