...
Time series of zooplankton diversity (effective shannon) (Figure \@ref(fig:zoo-div)) was calculated using 42 zooplankton classifications collected fromt the EcoMon cruises, referenced above. 
...
### Plotting
Code used to create the figures below can be found linked here, [zooplankton abundance](https://github.com/NOAA-EDAB/ecodata/blob/master/chunk-scripts/LTL.Rmd-MAB-zoo-abund.R) (\@ref(fig:copepod)) and [zooplankton diversity](https://github.com/NOAA-EDAB/ecodata/blob/master/chunk-scripts//LTL.Rmd-MAB-zoo-abund1.R) (\@ref(fig:zoo-div) ). 

#### Abundance anomaly

```{r copepod, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-zoo-abund.R"), fig.cap= "Pteropods and *Psuedocalanus spp.* zooplankton abundance anomaly in the Mid-Atlantic.",  echo = F, fig.align='default',warning = F,fig.show = 'hold'}
