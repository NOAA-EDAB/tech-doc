...
**Abundance anomaly**
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/data-raw/get_zoo_anom_sli.R"), eval = F, echo = T}

```


**Seasonal abundance**
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/data-raw/process_oi.R"), eval = F, echo = T}

```


```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/data-raw/get_zoo_oi.R"), eval = F, echo = T}
