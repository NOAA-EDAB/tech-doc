...
emaxgroups <- readRDS(here::here("data","EMAXconceptualmodgroups.RDS"))  
emaxgroups<-emaxgroups %>%   select(-Notes)
knitr::kable(emaxgroups, "latex", caption="Relationship between food web model groups and conceptual model focal groups. Pinnipeds not included in GB and Seabirds not included in MAB.", booktabs = T) %>% 
