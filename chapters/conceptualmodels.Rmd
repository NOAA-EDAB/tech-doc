...
group by svspp,year,cruise6,stratum,station,COLLCAT order by svspp,year,
...
Select svspp,year,cruise6,stratum,station,pdlen,COLLCAT,sum(pyamtv) sumpvol 
from fhdbs.allfh_feast where pynam <> 'BLOWN' and pynam <> 'PRESERVED' and 
pynam <> ' ' and svspp='073' and YEAR BETWEEN '1973' AND '2016' and 
GEOAREA='GB' group by svspp,year,cruise6,stratum,station,pdlen,COLLCAT order by svspp,year,cruise6,stratum,station,pdlen,COLLCAT
