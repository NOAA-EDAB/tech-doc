...
```{r, code = readLines("https://github.com/NOAA-EDAB/ecodata/blob/master/chunk-scripts/human_dimensions_MAB.Rmd-hms-landings-comdat-commercial_landings.R"), eval = T, echo = F, fig.cap = "Highly migratory species landings."}
