...
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-ch-bay-sal.R"), echo = F, fig.align="center", eval = T, fig.cap="Buoy data showing unprecedented fresh water in Chesapeake Bay."}

```


```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-ch-bay-temp.R"), echo = F, fig.align="center", eval = T, fig.cap="Buoy data showing unprecedented fresh water in Chesapeake Bay."}
