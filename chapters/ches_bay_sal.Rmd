...
Code used to build the plots below can be found here ([Salinity](https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-ch-bay-sal.R), [Temperature](https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-ch-bay-temp.R)).

```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-ch-bay-sal.R"), echo = F, fig.align="center", eval = T, fig.cap="Buoy data showing 2022 salinity compared to the longterm climatology (2010-2020) in Chesapeake Bay."}

```


```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-ch-bay-temp.R"), echo = F, fig.align="center", eval = T, fig.cap="Buoy data showing temperature of 2022 compared to the longterm climatology (2010-2020) in Chesapeake Bay."}
