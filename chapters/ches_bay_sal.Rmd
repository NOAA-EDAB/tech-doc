...
```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-ch-bay-sal.R"), echo = F, fig.align="center", eval = T, fig.cap="Buoy data showing 2021 salinity compared to the longterm climatology (2010-2020) in Chesapeake Bay."}

```


```{r , code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/LTL_MAB.Rmd-ch-bay-temp.R"), echo = F, fig.align="center", eval = T, fig.cap="Buoy data showing temperature of 2021 compared to the longterm climatology (2010-2020) in Chesapeake Bay."}
