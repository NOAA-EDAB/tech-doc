...
<!-- ```{r occupancy-MAB, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/tech-doc/master/R/stored_scripts/observer_data_plotting.R"), fig.cap="Summer flounder spring (A) and fall (B) occupancy habitat area in the Northeast Large Marine Ecosystem. ", echo = F, fig.show='hold', warning = F, message = F,fig.pos='H'} -->
