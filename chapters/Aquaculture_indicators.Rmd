...
```{r, code = readLines("https://raw.githubusercontent.com/NOAA-EDAB/ecodata/master/chunk-scripts/human_dimensions_MAB.Rmd-aquaculture-pieces.R"), fig.cap=".",echo = F, eval =T, warning = F, message=F}
```
