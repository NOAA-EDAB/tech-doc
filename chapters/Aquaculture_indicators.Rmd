...
### Plotting
Code for plotting data included in the State of the Ecosystem report can be found [here](https://raw.githubusercontent.com/NOAA-EDAB/SOE-MAFMC/master/chunk_scripts/MA-oyster-aqua.R). 
