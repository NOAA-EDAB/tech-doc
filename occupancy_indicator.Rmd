...
**Public availability statement**: Source data are available upon request (see [Survdat](#survdat), [CHL/PP](#chl-pp), and Data Sources below for more information). Model-derived time series are available [here](https://comet.nefsc.noaa.gov/erddap/tabledap/SOE_habitat_2018.html).
...
soe.plot(SOE.data.2018, "Time", "sumflo spring habitat occupancy", stacked = "A",
         rel.y.num = 1.1, scale.axis = 10^3, end.start = 2007, full.trend = F,
         cex.stacked = 1.5)
soe.plot(SOE.data.2018, "Time", "sumflo fall habitat occupancy", stacked = "B",
         rel.y.num = 1.1, scale.axis = 10^3, end.start = 2007, full.trend = F,
         cex.stacked = 1.5)
