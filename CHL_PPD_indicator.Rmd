...
* If SeaWiFS and RBR is $R_{rs}(490)/R_{rs}(555)(R_{^3{\mskip -5mu/\mskip -3mu}_5})$ then: A~0~=0.02534, A~1~=-3.033, A~2~=2.096, A~3~=-1.607
* If SeaWiFS and RBR is $R_{rs}(490)/R_{rs}(670)(R_{^3{\mskip -5mu/\mskip -3mu}_6})$  then: A~0~=1.351, A~1~=-2.427, A~2~=0.9395, A~3~=-0.2432
* If MODIS and RBR is $R_{rs}(488)/R_{rs}(547)(R_{^3{\mskip -5mu/\mskip -3mu}_5})$  then: A~0~=0. 03664, A~1~=-3.451, A~2~=2.276, A~3~=-1.096
* If MODIS and RBR is $R_{rs}(488)/R_{rs}(667)(R_{^3{\mskip -5mu/\mskip -3mu}_6})$  then: A~0~=1.351, A~1~=-2.427, A~2~=0.9395, A~3=-0.2432
...
<ol type="a">
  <li>If R~3/5~ >0.15 or R~6~<0.0001 then CHL-PAN = C~3/5~;</li>
  <li> Otherwise, CHL-PAN = max(C~3/5~, C~3/6~),</li>
</ol>

where R~6~ is R~rs~(670) (SeaWiFS) or R~rs~(667) [@SOE13]. 
