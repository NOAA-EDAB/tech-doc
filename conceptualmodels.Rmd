...
#### Human dimensions submodels
Recreational fisheries data were extracted from the 2010-2014 MRIP datasets. Original data can be found [here]( data\top10_prim1_common_mode.xlsx) for each region (New England or Mid-Atlantic as defined by states). 
...
The conceptual model documentation spreadsheet is available [here](http://comet.nefsc.noaa.gov/erddap/tabledap/concept_model_2018.htmlTable?Submodel,FROM_IEA_Conceptual_Model_Focal_Component,FROM_Focal_component_Element,TO_IEA_CM_Linked_Component,TO_Linked_component_element_level,Link_Description,Link_Magnitude,Link_Uncertainty,Supporting_Information), and can be downloaded with a script:
...
id <- as.character("concept_model_2018")
...
All source data aside from confidential commercial fisheries data (relevant only to some components of the conceptual models) are available to the public.
