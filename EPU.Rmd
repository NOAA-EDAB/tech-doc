...
```{r EPU maps, echo = T, fig.align='center', echo = F, fig.cap="**Figure 1:** Map of the four Ecological Production Units, including the Mid-Atlantic Bight (light blue), Georges Bank (red), Western-Central Gulf of Maine (or Gulf of Maine; green), and Scotian Shelf-Eastern Gulf of Maine (dark blue)."}
image.dir <- './images'
image_read(file.path(image.dir,"EPUs.jpg"))
```
