...
|Sea Surface Temperature|	Satellite Imagery (4km grid)|	&degC annual average|
|Sea Surface Temperature|	Satellite Imagery (4km grid)|	dimensionless|
|Sea Surface Temperature|	Satellite Imagery (4km grid)|	&degC annual average|
|Surface Temperature|	Shipboard hydrography (point)|	&degC (Spring and Fall)|
|Bottom Temperature|	Shipboard hydrography (point)|	&degC (Spring and Fall)|
...
```{r EPU maps,  fig.cap="Map of the four Ecological Production Units, including the Mid-Atlantic Bight (light blue), Georges Bank (red), Western-Central Gulf of Maine (or Gulf of Maine; green), and Scotian Shelf-Eastern Gulf of Maine (dark blue) \\label{EPUmap}", fig.align='center', echo = F}
image.dir <- './images'
...
Shapefiles for GIS analysis based on these EPUs are available ["EPU_Extended" shapefiles](https://github.com/NOAA-EDAB/tech-memo/tree/master/gis). Data used in this analysis are available to the public **(location TBD)**.
