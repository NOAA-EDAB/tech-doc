...
bibliography: Zooplankton_SOE.bib
---
...
Zooplankton data are from the NOAA MARMAP and EcoMon cruises detailed extensively in Kane (2007, 2011) and Morse et al. 2017.

### Data extraction 
Data are from the publicly available zooplankton dataset on the NOAA ftp site. The excel file has a list of excluded samples and cruises based on Kane (2007, 2011).
...
Ryan Morse, NEFSC EDAB, ryan.morse@noaa.gov
Harvey Walsh, NEFSC OCB, harvey.walsh@noaa.gov

#### Data steward (can be POC; in charge of keeping data updated)
Harvey Walsh, NEFSC OCB
Mike Jones, NEFSC DMS, michael.jones@noaa.gov
