...
**Data steward**: Gina Shield, FSB Database Lead
  
**Point of contact**: Gina Shield, FSB Database Lead
  
**Public availability statement**: Aggregated data is available to the public upon request.
...
R code used in aggregation and plotting
```{r analysis, echo = T, eval = F}

# Aggregating time series from source data=====================
# d <- source[source$SPECIES == "KINGFISH, SOUTHERN",]
# total_by_year <- d %>% group_by(YEAR) %>% dplyr::summarise(n = n())
#==============================================================
